...
if (isset($_POST['submit2'])) {
    ...
    $cccd = $_POST['identitycard'];
    $status = 0;
    $sql = "INSERT INTO datcho(magoi,emailnguoidat,tungay,denngay,binhluan,tinhtrang,cccd) VALUES(:pid,:useremail,:fromdate,:todate,:comment,:status,:cccd)";
    ...
    <div class="banner-3">
        <div class="container">
            <h1 class="wow zoomIn animated animated" data-wow-delay=".5s"
                style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Chi tiết</h1>
        </div>
    </div>
    <!--- /banner ---->
    <!--- selectroom ---->
                    ...
                    <form name="book" method="post">
                        <div class="selectroom_top">
                            ...
                            <div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
                                <h2><?php echo htmlentities($result->tengoi); ?></h2>
                                <p class="dow">#PKG-<?php echo htmlentities($result->magoi); ?></p>
                                <p><b>Loại hình:</b> <?php echo htmlentities($result->kieugoi); ?></p>
                            ...
                            <p style="padding-top: 1%"><?php echo htmlentities($result->mota); ?> </p>
                            <div class="clearfix"></div>
                        </div>
                        <div class="selectroom_top">
                            <div class="selectroom-info animated wow fadeInUp animated" data-wow-duration="1200ms"
                                ...
                                <ul>
                                    <li class="spe">
                                        <label class="inputLabel">Căn cước công dân</label>
                                        <input class="special" type="text" name="identitycard" maxlength="12" pattern="\d{12}"
