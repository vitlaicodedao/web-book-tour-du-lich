                        ...
                        <a href="manage-packages.php" target="_blank">
                            <div class="col-md-6 four-grid">
                                <div class="four-wthree">
                                    ...
                                    <div class="four-text">
                                        <h3>Gói du lịch</h3>
                                        <?php $sql3 = "SELECT magoi from goidulich";
                        ...
                        <div class="four-grids">
                            <div class="col-md-4 four-grid">
                                <div class="four-agileinfo">
                                    ...
                                    <div class="four-text">
                                        <h3>Câu hỏi</h3>
                                        <?php $sql2 = "SELECT mayeucau from yeucau";
                        ...
                        <div class="col-md-4 four-grid">
                            <div class="four-agileits">
                                ...
                                <div class="four-text">
                                    ...
                                    <?php $sql = "SELECT mayeucau from yeucau where (tinhtrang is null || tinhtrang='')";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                                    $results = $query->fetchAll(PDO::FETCH_OBJ);
                        ...
                        <div class="col-md-4 four-grid">
                            <div class="four-w3ls">
                                ...
                                <div class="four-text">
                                    ...
                                    <?php $sql5 = "SELECT mayeucau from yeucau where (tinhtrang='1')";
                    ...
                    <a href="manage-bookings.php" target="_blank">
                        <div class="col-md-3 four-grid">
                            <div class="four-agileinfo">
                                ...
                                <div class="four-text">
                                    <h3>Lượt đặt</h3>
                                    <?php $sql1 = "SELECT madat from datcho";
                        ...
                        <div class="col-md-3 four-grid">
                            <div class="four-wthree" style="color:#ffc107 !important">
                                ...
                                <div class="four-text">
                                    ...
                                    <?php $sql = "SELECT madat from datcho where (tinhtrang is null || tinhtrang='')";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                                    $results = $query->fetchAll(PDO::FETCH_OBJ);
                        ...
                        <div class="col-md-3 four-grid">
                            <div class="four-agileits">
                                ...
                                <div class="four-text">
                                    ...
                                    <?php $sql = "SELECT madat from datcho where (tinhtrang='2')";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                                    $results = $query->fetchAll(PDO::FETCH_OBJ);
                        ...
                        <div class="col-md-3 four-grid">
                            <div class="four-w3ls">
                                ...
                                <div class="four-text">
                                    ...
                                    <?php $sql = "SELECT madat from datcho where (tinhtrang='1')";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                                    $results = $query->fetchAll(PDO::FETCH_OBJ);
                                    $cancelbooking = $query->rowCount();
