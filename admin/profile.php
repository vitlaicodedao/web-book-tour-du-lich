...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "update admin set tenadmin=:name,email=:email,sodienthoai=:mobile where tendangnhap=:adminid";
                    ...
                    <div class="grid-form1">
                        ...
                        <div class="panel-body">
                            <form name="chngpwd" method="post" class="form-horizontal" onSubmit="return valid();">
                                <?php
                                $adminid = $_SESSION['alogin'];
                                $sql = "SELECT * from admin where tendangnhap=:adminid";
                                $query = $dbh->prepare($sql);
                                $query->bindParam(':adminid', $adminid, PDO::PARAM_STR);
                                $query->execute();
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control1" type="text" name="name" id="name"
                                                        value="<?php echo $result->tendangnhap; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control1" type="text" name="name" id="name"
                                                        value="<?php echo $result->tenadmin; ?>">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control1" type="text" name="mobile" id="mobile"
                                                        value="<?php echo $result->sodienthoai; ?>">
                                                </div>
                                            </div>
                                        </div>
