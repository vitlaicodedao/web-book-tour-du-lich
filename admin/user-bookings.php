                ...
                <div class="agile-grids">
                    ...
                    <div class="agile-tables">
                        <div class="w3l-table-info">
                            <h2>Quản lý lượt đặt tour của <?php echo $_GET['uname']; ?></h2>
                            <table id="table">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                ...
                                <tbody>
                                    <?php $uid = $_GET['uid'];
                                    $sql = "SELECT datcho.madat as bookid,khachhang.hoten as fname,khachhang.sodienthoai as mnumber,khachhang.email as email,
                                        goidulich.tengoi as pckname,datcho.madat as pid,datcho.tungay as fdate,datcho.denngay as tdate,
                                        datcho.binhluan as comment,datcho.tinhtrang as status,datcho.duochuyboi as cancelby,datcho.ngaycapnhat as upddate from  datcho
                                    left join khachhang  on  datcho.emailnguoidat=khachhang.email
                                    left join goidulich on goidulich.magoi=datcho.magoi where datcho.emailnguoidat='$uid'";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {                ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlentities($result->fdate); ?> Đến
                                                ...
                                                <td><?php if ($result->status == 0) {
                                                    ...
                                                    if ($result->status == 2 and  $result->cancelby == 'a') {
                                                        echo "Huỷ bởi bạn vào " . $result->upddate;
                                                    }
                                                    if ($result->status == 2 and $result->cancelby == 'u') {
                                                        echo "Huỷ bởi bạn vào lúc " . $result->upddate;
                                                    }
                                                    ?></td>
