...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "update goidulich set tengoi=:pname,kieugoi=:ptype,diadiem=:plocation,giatien=:pprice,phuongtien=:pfeatures,mota=:pdetails where magoi=:pid";
        ...
        $query->execute();
        $msg = "Cập nhật thông tin tour thành công.";
    }
                    ...
                    <div class="grid-form1">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                ...
                                <?php
                                $pid = intval($_GET['pid']);
                                $sql = "SELECT * from goidulich where magoi=:pid";
                                $query = $dbh->prepare($sql);
                                $query->bindParam(':pid', $pid, PDO::PARAM_STR);
                                $query->execute();
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control1" name="packagename" id="packagename"
                                                        placeholder="Tên gói" value="<?php echo htmlentities($result->tengoi); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control1" name="packagetype" id="packagetype"
                                                        placeholder="Kiểu gói" value="<?php echo htmlentities($result->loaigoi); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control1" name="packagelocation"
                                                        id="packagelocation" placeholder="Địa điểm"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control1" name="packageprice" id="packageprice"
                                                        placeholder="Giá tiền" value="<?php echo htmlentities($result->giatien); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control1" name="packagefeatures"
                                                        id="packagefeatures" placeholder="Phương tiện đi lại"
                                                        value="<?php echo htmlentities($result->phuongtien); ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" rows="5" cols="50" name="packagedetails"
                                                        id="packagedetails" placeholder="Mô tả"
                                                        required><?php echo htmlentities($result->mota); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="focusedinput" class="col-sm-2 control-label">Hình ảnh</label>
                                                <div class="col-sm-8">
                                                    <img src="pacakgeimages/<?php echo htmlentities($result->anh); ?>"
                                                        width="200">&nbsp;&nbsp;&nbsp;<a
                                                        href="change-image.php?imgid=<?php echo htmlentities($result->magoi); ?>">Change
                                                        Image</a>
                                                </div>
                                            </div>
