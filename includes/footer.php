...
<div class="copy-right">
    <div class="container">
        <div class="footer-social-icons wow fadeInDown animated animated" data-wow-delay=".5s"
            ...
            <ul>
                <li><a class="facebook"
                        href="https://www.facebook.com/profile.php?id=100028972894477"><span>Facebook</span></a></li>
                <li><a class="twitter" href="#"><span>Twitter</span></a></li>
                <li><a class="flickr" href="#"><span>Flickr</span></a></li>
                <li><a class="googleplus" href="mailto:nguyenthientoan061101@gmail.com"><span>Google+</span></a></li>
