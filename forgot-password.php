...
if (isset($_POST['submit50'])) {
    ...
    $sql = "SELECT email FROM khachhang WHERE email=:email and sodienthoai=:mobile";
    ...
    if ($query->rowCount() > 0) {
        $con = "update khachhang set matkhau=:newpassword where email=:email and sodienthoai=:mobile";
