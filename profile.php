...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit6'])) {
        ...
        $sql = "update khachhang set hoten=:name,sodienthoai=:mobileno where email=:email";
        $query = $dbh->prepare($sql);
        $query->bindParam(':name', $name, PDO::PARAM_STR);
        $query->bindParam(':mobileno', $mobileno, PDO::PARAM_STR);
        $query->bindParam(':email', $email, PDO::PARAM_STR);
        $query->execute();
        $msg = "Cập nhật trang cá nhân thành công.";
    }
            ...
            <div class="privacy">
                <div class="container">
                    <h3 class="wow fadeInDown animated animated" data-wow-delay=".5s"
                        style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Trang cá nhân</h3>
                    <form name="chngpwd" method="post">
                        ...
                        $sql = "SELECT * from khachhang where email=:useremail";
                        $query = $dbh->prepare($sql);
                        ...
                        if ($query->rowCount() > 0) {
                            foreach ($results as $result) {    ?>
                                ...
                                <p style="width: 350px;">
                                    ...
                                    <b>Tên</b> <input type="text" name="name" value="<?php echo htmlentities($result->hoten); ?>"
                                ...
                                <p style="width: 350px;">
                                    ...
                                    <input type="text" class="form-control" name="mobileno" maxlength="10"
                                        value="<?php echo htmlentities($result->sodienthoai); ?>" id="mobileno" required="">
                                </p>
                                ...
                                <p style="width: 350px;">
                                    <b>Ngày đăng kí:</b>
                                    <?php echo htmlentities($result->ngaydangky); ?>
                                </p>
                        <?php }
                        } ?>
