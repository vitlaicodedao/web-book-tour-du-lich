            ...
            <section>
                <div class="modal-body modal-spa">
                    <div class="login-grids">
                        <div class="login">
                            ...
                            <div class="login-right">
                                <form name="signup" method="post">
                                    ...
                                    <input type="text" value="" placeholder="Tên Đầy Đủ" name="fname" autocomplete="off"
                                        required="">
                        ...
                        <p>Bằng cách đăng nhập, bạn đã đồng ý với <a href="../terms.php">Điều khoản sử dụng
                            </a>
                            và <a href="../privacy.php">Chính sách bảo mật </a> của chúng tôi</p>
                    </div>
                </div>
            </section>
        </div>
